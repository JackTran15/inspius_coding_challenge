...
import { FootBallMatchScheduleService } from './football-match-schedule.service';
...
describe('FootballMatchSchedule Service Spec', () => {
  let service: FootBallMatchScheduleService;
  let repositoryMock: MockType<Repository<FootballMatchSchedule>>;
  ...
  beforeEach(async () => {
    ...
    service = module.get<FootBallMatchScheduleService>(
      FootBallMatchScheduleService,
    );
    repositoryMock = module.get(getRepositoryToken(FootballMatchSchedule));
  });
  ...
  it('should find all FootballMatchSchedule', async () => {
    const paging = {
      skip: 0,
      limit: 10,
    };

    const docs = new Array(20).fill(0).map((_) => new FootballMatchSchedule());
    ...
    const signalFootballMatchSchedule = await service.find({
      skip: paging.skip,
      take: paging.limit,
    });
    ...
    expect(signalFootballMatchSchedule).toStrictEqual(expected);
  });

  describe('FootballMatchSchedule using function findByIds', () => {
  ...
  describe('FootballMatchSchedule using function find', () => {
    it('should return a list of entities with pagination information', async () => {
      // Arrange
      const paging = {
        skip: 0,
  ...
  describe('FootballMatchSchedule using function findOne', () => {
    it('should return record of entities information', async () => {
      ...
      const doc = new FootballMatchSchedule();
  ...
  describe('FootballMatchSchedule using function findById', () => {
    it('should return record of entities information', async () => {
      // Arrange
      const id = 1;
      const options = {
  ...
  describe('FootballMatchSchedule using function store', () => {
